...
Route::group(['prefix' => 'user/', 'middleware' => 'auth:sanctum'], function () {
 ...
 Route::get('/brand', [CountryController::class, 'brand']);
 Route::post('/model', [CountryController::class, 'model']);
 Route::get('/image_cat', [CountryController::class, 'image_cat']);
 Route::post('/image_sub_cat', [CountryController::class, 'image_sub_cat']);