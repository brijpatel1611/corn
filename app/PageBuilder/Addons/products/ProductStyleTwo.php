...
class ProductStyleTwo extends PageBuilderBase
{
    ...
    {
        return 'product/right-style-01.png';
    }
    ...
    public function frontend_render(): string
    {
        ...
        // first we need to check if admin select tax based on vendor shop address then get information about vendor address
        ...
        return $this->renderBlade("product/right-style-01", compact("section_title","padding_top","padding_bottom","products"));
    }

    public function addon_title(): array|string|Translator|Application|null
    {
        return __("Right side product: 01");
    }
}