...
class ProductSliderThree extends PageBuilderBase
{
    use RepeaterHelper;
    ...
    public function admin_render()
    {
        ...
        // product
        $output .= '<div class="all-field-wrap">';
        $products = Product::where(['status_id' => 1])->get()->pluck('name', 'id')->toArray();
    ...
    public function frontend_render(): string
    {
        ...
        $title_image = SanitizeInput::esc_html($settings['title_image']);
        ...
        return $this->renderBlade('product.product_slider_three', $section_data);
    }
}
